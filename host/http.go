...
func (h *hostAPI) ListJobs(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
...
func (h *hostAPI) GetJob(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	id := ps.ByName("id")
...
func (h *hostAPI) StopJob(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	id := ps.ByName("id")
...
func (h *hostAPI) RegisterRoutes(r *httprouter.Router) error {
